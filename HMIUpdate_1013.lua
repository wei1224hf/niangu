    ...
    if _ret >= 1 then    
      ...
      if ( (_l ~= _req[7]) or (_h ~= _req[8])) then
        ...
        elseif _req[2] == 6 then
          ...
          local _name = names[_req[4]]
          if (_name == "Svwireerror1") or (_name == "SvwireActualSpeed1_lo") or (_name == "SvwireActualSpeed1_hi") or (_name == "SvwireActualTorque1_lo") or (_name == "Tension_hi") or (_name == "Tension_hi") then
            TPWrite2(_name)
